...
def _doc_texts() -> dict[str, str]:
    paths = [
        ...
        DOCS / "rpf_current_experiment_summary.md",
        DOCS / "rpf_binary_walkforward_audit_summary.md",
        DOCS / "rpf_ranked_signal_plan.md",
        DOCS / "rpf_walkforward_code_review_cleanup.md",
        ...
        DOCS / "rpf_binary_classification_experiment.md",
        DOCS / "rpf_binary_walkforward_process.md",
        DOCS / "rpf_binary_prediction_pipeline_contract.md",
        DOCS / "rpf_cnn_feature_diagnostic.md",
        DOCS / "rpf_overfit_control_protocol.md",
        DOCS / "rpf_regime_gated_prediction_plan.md",
        DOCS / "rpf_regime_gate_implementation_todo.md",
        DOCS / "rpf_signal_bank_batch_selection.md",
        DOCS / "rpf_separate_decision_banks.md",
        DOCS / "rpf_ema_regime_batch_selection.md",
