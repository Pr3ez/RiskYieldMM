...
export declare const STRICTNESS_BY_TYPE: Record<TaskType, WorkflowStrictness>;
/**
...
export declare const DEFAULT_THRESHOLDS: MetricThresholds;
/**
 ...
 */
export declare function createInitialMetrics(sessionId: string): CognitiveMetrics;
/**
 ...
 */
export type PathologyType = 'reason-excess' | 'reason-deficiency' | 'spirit-excess' | 'spirit-deficiency' | 'appetite-excess' | 'appetite-deficiency';
/**
 * Detected pathology
 */
