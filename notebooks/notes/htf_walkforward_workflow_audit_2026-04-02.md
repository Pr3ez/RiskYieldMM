# HTF Walk-Forward Workflow Audit - 2026-04-02
...
- Machine-readable manifest: `/media/przem/linux_data/RiskYieldMM (Copy)/test_output/htf_walkforward_diagnostics/20260402_183558/workflow_manifest.json`
...
- Best full-coverage method: `per_class_specialist` / `spc=3_rp=1.0_floor=0.2`
- Best full-coverage directional accuracy: `0.5158881578947369`
- Best reduced-coverage method: `all_agree_direction` / `direct`
- Direct baseline directional accuracy: `0.5041995614035087`
- Incomplete combo batches filtered: `0`
...
- Stage-1 eval batch range: `5290..5669` (`n=380`)
- Evaluated rows: `91200`
- Best full-coverage method: `discounted_model_averaging` / `eta_model=4.0_eta_gamma=2.0_loss=acc_cde`
- Best full-coverage directional accuracy: `0.5435416666666667`
- Best reduced-coverage method: `all_agree_class` / `direct`
- Direct baseline directional accuracy: `0.5165570175438596`
- Incomplete combo batches filtered: `0`
