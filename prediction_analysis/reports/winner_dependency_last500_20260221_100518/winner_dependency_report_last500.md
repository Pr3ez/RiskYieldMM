...
- Generated (UTC): 2026-02-21T10:05:18.516643+00:00
...
- Missing step diagnostics rows: 353 (see diagnostic_missing_steps_last500.csv)
...
- HIGH: acc=0.802, dir_acc=nan, cross_dir_err=nan, true_up=0.412, pred_up=0.418, fold_mean=1.40
- LOW: acc=0.435, dir_acc=nan, cross_dir_err=nan, true_up=0.352, pred_up=0.398, fold_mean=2.02
- Top configs over-indexed in HIGH bucket (min 5 wins):
...
- LOW: acc=0.425, dir_acc=nan, cross_dir_err=nan, true_up=0.327, pred_up=0.424, fold_mean=1.64
- Top configs over-indexed in HIGH bucket (min 5 wins):
...
- HIGH: acc=0.808, dir_acc=nan, cross_dir_err=nan, true_up=0.427, pred_up=0.450, fold_mean=1.37
- LOW: acc=0.427, dir_acc=nan, cross_dir_err=nan, true_up=0.304, pred_up=0.406, fold_mean=1.86
- Top configs over-indexed in HIGH bucket (min 5 wins):
  ...
  - f2_v3_t24: wins=5, high=4 (0.800), uplift=0.170, dir_acc=nan, pred_up=0.225
- Top configs over-indexed in LOW bucket (min 5 wins):
  - f2_v2_t16: wins=11, high=4 (0.364), uplift=-0.266, dir_acc=0.517, pred_up=0.489
  - f2_v4_t28: wins=5, high=2 (0.400), uplift=-0.230, dir_acc=nan, pred_up=0.287
  - f1_v3_t15: wins=27, high=15 (0.556), uplift=-0.075, dir_acc=nan, pred_up=0.481
